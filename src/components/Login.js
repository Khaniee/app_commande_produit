...
function Login() {
    ...
    return (
        <div style={{ height: "100vh", display: "flex", justifyContent: "center", alignItems: "center", textAlign: "center", flexDirection: "column" }}>
            <div className='container' style={{ width: "30%" }}>
                {connectedUser ? (
                    <div className="alert alert-success" role="alert">
                        <b>Connected user : </b>
                        <Image src={connectedUser.image} alt="not found" thumbnail style={{ width: "3rem", height: "3rem" }} />
                        ...
                        <Button variant="danger" onClick={() => { setconnectedUser(null); setloginIncorrect(false) }}>Se déconnecter</Button>
                    ...
                    <Card style={{ height: "20rem" }}>
                        ...
                        <Card.Body style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                            <Form onSubmit={(event) => {
                                ...
                                <Button disabled={connectedUser !== null} variant="primary" type="submit">Se connecter</Button>
                            </Form>
                        </Card.Body>
                    </Card>}
            </div>
